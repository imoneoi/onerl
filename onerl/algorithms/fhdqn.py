...
class FHDQNAlgorithm(Algorithm):
    def __init__(
        ...
        # action
        assert "act_n" in self.env_params, "FHDQNAlgorithm: Environment actions must be discrete."
        ...
        assert self.eps_start >= self.eps_final, "FHDQNAlgorithm: eps_start must be larger than eps_final."
        # optimizer
